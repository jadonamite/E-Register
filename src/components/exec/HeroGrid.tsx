    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
      ...
      >
        ...
        <div className="relative z-10">
          <span className="text-6xl font-black tracking-tighter text-stone-900 block">
            {data?.totalMembers || 0}
          </span>
      ...
      {/* 2. RISK (The "Locked In" Black Card) */}
      <motion.div 
      ...
      >
        ...
        <div className="flex justify-between items-start relative z-10">
           ...
           <div className="px-3 py-1 bg-white rounded-full border border-emerald-100 shadow-sm">
             <span className="text-[10px] font-black uppercase tracking-widest text-emerald-600">Leading Cell</span>
           </div>
        </div>

        <div className="relative z-10">
          <h3 className="text-4xl font-black tracking-tighter text-emerald-900 leading-tight">
            {topCell}
          </h3>
          <p className="text-emerald-600/70 font-bold text-xs uppercase tracking-wider mt-2">
            Highest Count ({topCellCount})
          </p>
        </div>
      </motion.div>
